...
copyFiles({
    files: {
        ...
        'knockout-sortable.min.js': 'app/node_modules/knockout-sortable/build/knockout-sortable.min.js',
        'jquery-ui.min.js': 'app/node_modules/jquery-ui-dist/jquery-ui.min.js'
    },
    dest: 'app/js/lib'
}, (err) => {});
